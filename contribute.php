...
<section class="page-hero">
    <div class="container">
        ...
        <p>RIT Racing is a 501(c)3 organization. Your contribution — monetary or in-kind — is tax deductible and goes directly toward building our next race car.</p>
    </div>
</section>
<section class="section">
    <div class="container">
        <div class="two-col">
            <div style="background:var(--rit-dark-2);border:1px solid var(--rit-dark-3);padding:3rem;" class="reveal">
                ...
                <p style="color:var(--rit-gray-light);line-height:1.8;margin-bottom:1.5rem;">
                    ...
                    As a 501(c)3 organization, we can provide tax credit documentation.
                </p>
                <div style="display:flex;gap:1rem;flex-wrap:wrap;">
                    <a href="<?= asset('files/rit-racing-sponsor-packet.pdf') ?>" target="_blank" class="btn btn-primary">
                        <i class="fa fa-download"></i> Download Sponsor Packet
                    </a>
                    <a href="mailto:<?= CONTACT_EMAIL ?>" class="btn btn-outline">
                        <i class="fa fa-envelope"></i> Contact Us
                    </a>
                </div>
            </div>
            <div style="background:var(--rit-dark-2);border:1px solid var(--rit-dark-3);padding:3rem;" class="reveal reveal-delay-2">
...
<section class="cta-section">
    <div class="container">
        ...
        <a href="<?= asset('files/rit-racing-sponsor-packet.pdf') ?>" target="_blank" class="btn-dark">
